...
def formatar_ajuda() -> str:
    return (
        ...
        "📝 *Lançamento múltiplo:*\n"
        "Primeira linha: data\n"
        "Linhas seguintes: descrição - valor - Grupo - Subgrupo\n"
        "Ex:\n"
        "`26/05/26`\n"
        ...
        "`resumo: DD/MM a DD/MM` _(período customizado)_\n\n"
        "📈 *Histórico (últimos 3 meses):*\n"
        "`historico: Grupo` ou `historico: Grupo > Subgrupo`\n"
        "Ex: `historico: Alimentação` ou `historico: Alimentação > Mercado`\n\n"
        "🕐 *Últimos lançamentos:*\n"
